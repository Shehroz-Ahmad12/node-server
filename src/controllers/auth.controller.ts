...
// import { emailTemplate } from "../libraries/nodemailer";
...
//     email,
//     "GPT Based - OTP",
//     emailTemplate(user.getToken(), "E-mail Verification", "verify-email")
//   );
...
//   await sendEmail(
//     email,
//     "GPT Based - Verification Link",
//     emailTemplate(
//       (user as IUserDocument).getToken(),
//       "Reset Password",
//       "reset-password"
//     )
//   );
